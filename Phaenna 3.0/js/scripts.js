...
function submitClickHandler() {
    ...
    setTimeout(resetSubmitClickText, 5000);
}
/**
 * Reset of submitResponseText after 5 sec.
 */
function resetSubmitClickText()
{
    var response = document.getElementById("submitResponseText");
